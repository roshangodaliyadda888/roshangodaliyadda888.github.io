...
- **Narthana, S., Sivasthigan, S., Thamayanthi, M., Godaliyadda, R., Ekanayake, P., & Herath, V.** (2026). *A Structured Analysis and Taxonomy of Scene Graph Representations for Group Activity Understanding*. Proceedings of the SG4SI Workshop, IEEE/CVF Winter Conference on Applications of Computer Vision (WACV), Tucson, Arizona.
- **Herath, D., Rathnayake, O., Alahakoon, T., Senadeera, S., Godaliyadda, R., & Ekanayake, P.** (2026). *FlowSegModel: Advancing Perception in Autonomous Driving Through Weather-Resilient Segmentation*. Proceedings of the IEEE 19th International Conference on Industrial and Information Systems (ICIIS-2025).
- **Rathnayake, O., Senadeera, S. V., Perera, S. A., Godaliyadda, R., Ekanayake, M. P., & Herath, V. R.** (2024). *Ego Vehicle Speed Estimation Using Optical Flow Analysis*. Proceedings of the 5th IEEE Global Conference for Advancement in Technology (GCAT).
- **Welikala, S., Liyanage, D., Abeysekara, A. D., Ekanayake, M. P. B., Godaliyadda, R. I., & Wijayakulasooriya, J. V.** (2016). *Control Strategy for Navigation of a Reconnaissance Robotic System*. ACTA Press Journal of Control and Intelligent Systems.
