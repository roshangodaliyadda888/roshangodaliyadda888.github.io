...
layout: page
title: CV Action
description: Lightweight and interpretable spatiotemporal modelling for group activities, interactions, and multi-entity scene understanding.
importance: 10
...
at each person in the scene and captures information about their appearance, position,
and movement over time. It then studies how people interact within each frame and
